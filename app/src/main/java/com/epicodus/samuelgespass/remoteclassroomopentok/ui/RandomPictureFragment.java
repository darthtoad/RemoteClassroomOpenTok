...
public class RandomPictureFragment extends Fragment implements Session.SessionListener, Session.SignalListener {
        ...
        reqQueue.add(new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    mSession.setSessionListener(RandomPictureFragment.this);
     ...
     * @return A new instance of fragment RandomPictureFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static RandomPictureFragment newInstance(String param1, String param2) {
        RandomPictureFragment fragment = new RandomPictureFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_random_picture, container, false);
        mImageButton = (ImageButton) view.findViewById(R.id.imageButton);
        try {
            connectToSession(mSessionId);
        } catch (OpenTokException ex) {
            Log.e("RandomPictureFragment", ex.getMessage());
        }
        return view;
    }
